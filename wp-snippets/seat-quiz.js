(function () {
  ...
  var SEATS = {
    ...
    ss: { name: 'SS席', catchcopy: '家族で最高の思い出を', price: '1テーブル 35,000円（4名掛けのテーブル席）',
      spec: ['指定席。カフェチェア、カフェテーブル付き。', '第7回と異なりテントはありません。', 'お席は購入時に自動で決まります（ご自身で選ぶことはできません）。', '5名以上でご来場の場合は、席の組み合わせをお問い合わせフォームからご相談ください。'],
    ...
    a: { name: 'A席', catchcopy: '迷ったらこれ！快適に楽しむ特等席', price: '大人 5,000円（13歳以上）／子ども 2,000円（12歳以下）',
      spec: ['指定席。テーブルなし。', 'お席は購入時に自動で決まります（ご自身で選ぶことはできません）。', '小さなお子さまの膝上観覧は無料です。', '5名以上でご来場の場合は、席の組み合わせをお問い合わせフォームからご相談ください。'],
    ...
    free: { name: 'フリーエリア', catchcopy: '西多摩在住者限定！フリーエリア', price: 'おとな 2,000円（13歳以上）／こども 1,000円（3歳～12歳）／2歳以下 無料',
      spec: ['限定1,000名。予定枚数に達し次第、販売を終了します。', '対象地域：青梅市・福生市・羽村市・あきる野市・瑞穂町・日の出町・檜原村・奥多摩町', 'エリア内の好きな場所で観覧できます。立ち見はできません。', '小さな折りたたみイス（背もたれなし・30cm程度）と人数分のレジャーシートは持ち込めます。', '受付で、お住まいを確認できる書類（身分証など）の提示をお願いする場合があります。', 'アソビューだけで販売しています。'],
